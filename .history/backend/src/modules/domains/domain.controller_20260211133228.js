...
export const getDomainById = async (req, res) => {
  try {
    ...
    const domain = await Domain.findOne({ _id: id, clientId: client._id }).lean();
    ...
    return successResponse(res, { domain }, 'Domain details retrieved');
  } catch (error) {
...
export const initiateTransfer = async (req, res) => {
  try {
    ...
    return successResponse(res, { result }, 'Domain transfer initiated');
  } catch (error) {
...
export const getTransferStatus = async (req, res) => {
  try {
    ...
    return successResponse(res, { domain, status }, 'Transfer status retrieved');
  } catch (error) {
...
export const listDNSRecords = async (req, res) => {
  try {
    ...
    return successResponse(res, { domain, records }, 'DNS records retrieved');
  } catch (error) {
...
export const upsertDNSRecord = async (req, res) => {
  try {
    ...
    return successResponse(res, { result }, 'DNS record upserted');
  } catch (error) {
...
export const deleteDNSRecord = async (req, res) => {
  try {
    ...
    return successResponse(res, { result }, 'DNS record deleted');
  } catch (error) {
...
export const updateContacts = async (req, res) => {
  try {
    ...
    return successResponse(res, { result }, 'Domain contacts updated');
  } catch (error) {
...
export const setLock = async (req, res) => {
  try {
    ...
    return successResponse(res, { result }, 'Domain lock status updated');
  } catch (error) {
...
export const setForwarding = async (req, res) => {
  try {
    ...
    return successResponse(res, { result }, 'Forwarding updated');
  } catch (error) {
...
export const removeForwarding = async (req, res) => {
  try {
    ...
    return successResponse(res, { result }, 'Forwarding removed');
  } catch (error) {
