import { FileText, Globe, TrendingUp, Wallet as WalletIcon, Loader2, ArrowRight, AlertCircle } from 'lucide-react';
    ...
    try {
      ...
      if (domainsRes.status === 'fulfilled' && domainsRes.value.data.domains?.length > 0) {
        ...
        recentDomains.forEach(domain => {
          activity.push({
            type: 'domain',
            title: `Domain Registered: ${domain.domain}`,
            date: domain.registeredAt,
