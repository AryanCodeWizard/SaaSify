          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="font-medium text-gray-900">{formatDate(domain.registeredAt)}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 mb-1">Expiry Date</p>
                <p className="font-medium text-gray-900">{formatDate(domain.expiresAt)}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 mb-1">Registration Period</p>
                <p className="font-medium text-gray-900">{domain.registrationPeriod} year(s)</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className={`text-sm font-medium ${domain.privacyProtection ? 'text-green-600' : 'text-gray-600'}`}>
                  {domain.privacyProtection ? 'On' : 'Off'}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center">
